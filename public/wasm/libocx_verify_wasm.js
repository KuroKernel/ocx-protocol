/* @ts-self-types="./libocx_verify_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function ocxVerifierVersion() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.ocxVerifierVersion(retptr);
 ...
 * @returns {any}
 */
export function ocxVerifyBytes(cbor, pubkey) {
    const ptr0 = passArray8ToWasm0(cbor, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(pubkey, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.ocxVerifyBytes(ptr0, len0, ptr1, len1);
 ...
 * @returns {any}
 */
export function ocxVerifyHex(cbor_hex, pubkey_hex) {
    const ptr0 = passStringToWasm0(cbor_hex, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(pubkey_hex, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.ocxVerifyHex(ptr0, len0, ptr1, len1);
    return takeObject(ret);
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./libocx_verify_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('libocx_verify_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
