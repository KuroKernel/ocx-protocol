// debug-server/main.go — Debug Server with detailed logging
package main
...
func NewDebugServer() (*DebugServer, error) {
	...
	return &DebugServer{repo: repo}, nil
}
...
func (s *DebugServer) handleVerify(w http.ResponseWriter, r *http.Request) {
...
func (s *DebugServer) handleReceipts(w http.ResponseWriter, r *http.Request) {
...
func main() {
	log.Println("🚀 Starting OCX Debug Server...")
	
	server, err := NewDebugServer()
	if err != nil {
